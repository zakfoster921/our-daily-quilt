...
function buildGeminiReflectionThemesPrompt({ dateKey, reflectionPrompt, responses }) {
  ...
  return [
    ...
    'Avoid therapy-speak, corporate language, and clichés like "journey", "holding space", "resilience", and "self-care".',
    'Keep each theme under 14 words.',
    'Prefer concrete language over abstract language.',
    'Do not start every theme with "People" or "A few responses".',
