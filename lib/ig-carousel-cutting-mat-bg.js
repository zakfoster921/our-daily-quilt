 ...
 * Crops four grid-aligned columns from ig-green-cutting-mat-wide (no repeat tiling).
 */
(function (root, factory) {
  ...
  function () {
     ...
     * Four slides = three internal cuts on ~6px grid (1024px → 256px columns).
     */
    const CAROUSEL_MAT_SLICE_X_FRACS = [0, 0.25, 0.5, 0.75, 1];
     ...
     * @param {number} panelW
     * @param {number} panelH
     * @param {number} panX — 0, 1080, 2160, or 3240
     */
