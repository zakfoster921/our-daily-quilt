...
function (global) {
  ...
  const STYLE_ID = 'quilt-mood-triptych-widget-styles-v130';
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #screen-quilt .quilt-mood-triptych__type-window {
        ...
        /* Stay glued to the face plane during the Y flip (above halftone ::before). */
  ...
  function mount(host, opts = {}) {
    ...
    function syncCardTypeWindows(faceFront, faceBack, frontMark, messageEl) {
