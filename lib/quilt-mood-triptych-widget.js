...
function (global) {
  ...
  const STYLE_ID = 'quilt-mood-triptych-widget-styles-v114';
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #screen-quilt .quilt-mood-triptych.is-instant .quilt-mood-triptych__card.is-dismissed {
        transition: none;
      }
  ...
  function mount(host, opts = {}) {
    ...
    function resetMood({ instant = false } = {}) {
      ...
      host.classList.remove('is-good', 'is-rough', 'is-open', 'is-locked');
