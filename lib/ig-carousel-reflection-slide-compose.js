...
(function (root, factory) {
  ...
  function (global) {
    ...
    const PATCH_FONT_PX = Math.round(36 * RESPONSE_CARD_SCALE);
    ...
    const PATCH_AUTHOR_GAP = Math.round(20 * RESPONSE_CARD_SCALE);
    ...
    function drawFabricPatch(ctx, x, y, w, h, rgbCsv, seedKey, highlighted, layout, highlightBorderImg) {
      ...
      const authorFontPx = layout.authorFontPx || Math.round(PATCH_FONT_PX * 0.82);
