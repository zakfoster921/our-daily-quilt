...
(function (root, factory) {
  ...
  function (global) {
    ...
    const PANEL_W = 1080;
    const PANEL_H = 1350;
    const CARD_LAYER_MARGIN_X = 20;
    const CARD_LAYER_MARGIN_Y = 24;
    const CARD_LAYER_WIDTH_RATIO = 0.94;
    ...
    function drawCardsLayerOnPanel(ctx, cardsLayer, panelW, panelH) {
      ...
      const maxH = Math.round(panelH * 0.58);
      ...
      const drawY = Math.round(CARD_LAYER_MARGIN_Y + 8);
