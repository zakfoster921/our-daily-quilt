...
(function (root) {
  ...
  /**
   * Lithograph multiply over quilt (Layout B IG): smooth ink + optional light grain.
   * No cream mat, scanner bed, or contour — those paint opaque light pixels and kill quilt bleed-through.
   */
  function drawSpeakerCutoutOverQuilt(g, img, rect, options = {}) {
    ...
    const grain =
      options.layers?.grain === true ? buildSpeakerGrainCanvas(portrait) : null;
    const multiplyAlpha =
