...
(function (root) {
  ...
  function buildSpeakerCreamBackdropCanvas(portrait, opts = {}) {
    ...
    const g = c.getContext('2d');
    if (!g) return null;
    g.fillStyle = opts.brightenBackground === true ? '#faf6ee' : '#f2eee6';
  ...
  function drawSpeakerCutoutOverQuilt(g, img, rect, options = {}) {
    ...
    const bgOpts = quiltScreen ? { brightenBackground: true } : {};
      ...
      options.portraitAlpha != null
        ...
        : useRadialWash
          ? quiltScreen
            ...
            : 0.92
          : 0.85;
    const washAlpha = options.washAlpha != null ? options.washAlpha : quiltScreen ? 0.66 : 0.62;
