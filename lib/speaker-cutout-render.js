...
(function (root) {
  ...
  /** Soft colored stock for IG speaker mat — accent quilt swatch (not dominant hue family). */
  function resolveIgCollagePaperColor(options = {}) {
    ...
    const rawSource = safeHex(
      pickIgCollagePaperQuiltSwatch(palette, fallback),
      IG_SPEAKER_COLLAGE_PAPER
    );
  ...
  /** IG slide 1 / Layout B: solid paper-mat collage instead of semi-transparent quilt bleed. ?igSpeakerOpaque=1 */
