...
(function (root) {
  ...
  function drawSpeakerCutoutOverQuilt(g, img, rect, options = {}) {
    ...
    const multiplyAlpha =
      options.portraitAlpha != null ? options.portraitAlpha : 0.68;
    const creamTintAlpha =
      options.creamTintAlpha != null ? options.creamTintAlpha : 0.12;
    const grainAlpha = options.grainAlpha != null ? options.grainAlpha : 0.18;
    const skipBed =
