    ...
    renderQueue.forEach(({ block, originalIndex }, i) => {
      ...
      if (
        ...
        if (block.specialPatternType === 'insetCircle') {
          ...
          const insetSeamUnderpaint = this._createGridSeamUnderpaintRect(
            block.x,
            block.y,
            w,
            h,
          ...
          insetSeamUnderpaint.setAttribute('fill', block.color);
          insetSeamUnderpaint.setAttribute('stroke', 'none');
          specialGroup.appendChild(insetSeamUnderpaint);
