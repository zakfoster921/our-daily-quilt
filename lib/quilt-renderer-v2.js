    ...
    if (renderMirroredField) {
      ...
      if (quadrantFourUpPreview) {
        ...
        if (duplicateNoMirrorPreview) {
          ...
          secondFieldTransform = splitBandLayout &&
            typeof QuiltMirrorLayout !== 'undefined' &&
            typeof QuiltMirrorLayout.splitBandBottomFieldTransformFromFlags === 'function'
            ? QuiltMirrorLayout.splitBandBottomFieldTransformFromFlags(
                minX,
                minY,
                actualQuiltWidth,
                actualQuiltHeight,
            ...
            : typeof QuiltMirrorLayout !== 'undefined'
            ? QuiltMirrorLayout.bottomFieldTransformFromFlags(
                minX,
                minY,
                actualQuiltWidth,
                actualQuiltHeight,
            ...
            : `translate(${minX + actualQuiltWidth} ${minY + actualQuiltHeight + mirrorSeamOffset - mirrorSeamOverlap}) scale(-1 -1)`;
        }
