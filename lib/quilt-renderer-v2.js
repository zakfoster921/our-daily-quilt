...
class QuiltRendererV2 {
  ...
  renderBlocks(blocks, userPieces = [], submissionCount = 0) {
    ...
    this.quiltSVG.setAttribute(
      'preserveAspectRatio',
      primaryOnlyPreview ? 'xMidYMid meet' : 'xMidYMin slice'
    );
    ...
    if (renderMirroredField) {
      const secondFieldTransform = duplicateNoMirrorPreview
        ? (typeof QuiltMirrorLayout !== 'undefined'
            ...
            : `translate(0 ${actualQuiltHeight + mirrorSeamOffset - mirrorSeamOverlap})`)
        : (typeof QuiltMirrorLayout !== 'undefined'
            ? QuiltMirrorLayout.mirrorTransform(
                minX,
                minY,
                actualQuiltWidth,
                actualQuiltHeight,
      ...
      mirroredLayer.setAttribute('transform', secondFieldTransform);
      if (duplicateNoMirrorPreview) {
      ...
      fieldLayer.insertBefore(mirroredLayer, parallaxLayer);
    }
