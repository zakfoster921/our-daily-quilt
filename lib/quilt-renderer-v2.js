...
class QuiltRendererV2 {
  ...
  _applyLightOverDarkGroupOpacity(group, opacity) {
    ...
    group.dataset.overlapOpacity = opacity.toFixed(3);
  ...
  _applyNewBlockAnimation(group) {
    ...
    group.addEventListener('animationend', () => {
      ...
      const overlapOpacity = group.dataset.overlapOpacity;
      if (overlapOpacity) group.setAttribute('opacity', overlapOpacity);
