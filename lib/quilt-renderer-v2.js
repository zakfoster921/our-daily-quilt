...
class QuiltRendererV2 {
  ...
  renderBlocks(blocks, userPieces = [], submissionCount = 0) {
    ...
    const useSavedDoubleBottomLayout =
    ...
    if (renderMirroredField) {
      ...
      if (quadrantFourUpPreview) {
        ...
        if (duplicateNoMirrorPreview) {
          ...
          if (savedMirrorFlags) {
            mirroredLayer.setAttribute('data-mirror-flip-x', savedMirrorFlags.flipX ? '1' : '0');
            mirroredLayer.setAttribute('data-mirror-flip-y', savedMirrorFlags.flipY ? '1' : '0');
            if (!savedMirrorFlags.flipX && !savedMirrorFlags.flipY) {
              mirroredLayer.setAttribute('data-duplicate-no-mirror', '1');
            } else if (!savedMirrorFlags.flipX && savedMirrorFlags.flipY) {
