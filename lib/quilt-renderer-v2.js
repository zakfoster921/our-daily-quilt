...
class QuiltRendererV2 {
  ...
  renderBlocks(blocks, userPieces = [], submissionCount = 0) {
    ...
    if (splitBandLayout) {
      ...
      fieldLayer.appendChild(mirrorBand);
      ...
      mirrorBand.setAttribute('clip-path', 'url(#quiltMirrorBandClip)');
      primaryBand.setAttribute('transform', splitBandLayout.primaryTransform);
      mirrorBand.setAttribute('transform', splitBandLayout.mirrorTransform);
    }
    ...
    if (renderMirroredField) {
      /** Meet mode uses full mirrorSeamOffset; split-band wrapper handles fold placement. */
      const bandMirrorSeamOffset = splitBandLayout ? mirrorSeamOverlap : mirrorSeamOffset;
      ...
      if (quadrantFourUpPreview) {
        ...
        const stackTransforms = typeof QuiltMirrorLayout !== 'undefined'
          ? duplicateDoubleBottomFlipLeftPreview
          ...
          : (() => {
              const firstTy = bandMirrorSeamOffset - mirrorSeamOverlap;
        ...
        if (useSavedDoubleBottomLayout && (doubleBottomTileNudgeY.left || doubleBottomTileNudgeY.right)) {
          const appendTileVerticalNudge = (transform, nudgeTileY) =>
            ...
            typeof QuiltMirrorLayout.odqAppendTileVerticalNudgeTransform === 'function'
              ? QuiltMirrorLayout.odqAppendTileVerticalNudgeTransform(transform, nudgeTileY, viewBoxHeight)
        ...
        if (duplicateNoMirrorPreview) {
          secondFieldTransform = typeof QuiltMirrorLayout !== 'undefined'
            ...
            : `translate(0 ${bandMirrorSeamOffset - mirrorSeamOverlap})`;
          ...
          secondFieldTransform = typeof QuiltMirrorLayout !== 'undefined'
            ...
            : (() => {
                const ty = bandMirrorSeamOffset - mirrorSeamOverlap;
                const cx = minX + actualQuiltWidth / 2;
          ...
          secondFieldTransform = typeof QuiltMirrorLayout !== 'undefined'
            ...
            : `translate(${minX + actualQuiltWidth} ${minY + actualQuiltHeight + bandMirrorSeamOffset - mirrorSeamOverlap}) scale(-1 -1)`;
        }
