    ...
    class PostColorCutRevealController {
      ...
      async play(options = {}) {
        ...
        const beginLiveHandoff = () => {
          ...
          // Leave the departing scrap on screen — the whole mat fades with it.
          this._els?.cutLayer
            ?.querySelectorAll?.('.post-color-cut-reveal__cut-line')
            ?.forEach?.((line) => line.classList.add('is-faded'));
