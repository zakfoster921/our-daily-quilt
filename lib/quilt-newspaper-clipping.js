...
function (global) {
  ...
  const DEFAULTS = {
    ...
    /** Warm newsprint cream — lighter than prior #f5e6d4; closer to quilt card #f6f2eb. */
    paper: '#f8f3eb',
    ...
    digitalExportScanFringeLight: 'rgba(255, 252, 245, 0.55)',
  ...
  function buildHandCutCssClipPath(w, h, dateKey, cfgIn = {}) {
    ...
    const ring = buildHandCutPolygon(iw, ih, seed, cfg);
