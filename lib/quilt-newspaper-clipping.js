...
function (global) {
   ...
   * Falls back to cfg.firstLineCount (default 4).
   */
  function resolveFirstLineCount(quote, cfg) {
    ...
    return Math.max(1, Math.min(12, Number.isFinite(fallback) && fallback > 0 ? Math.round(fallback) : 4));
  }
