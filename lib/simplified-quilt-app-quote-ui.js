...
(function (root) {
  ...
  class SimplifiedQuiltAppV2QuoteUi {
      ...
      handleHueSliderChange(e) {
        ...
        if (!this._userExplicitSatPick && this.selectedSaturation < 40) {
          this.selectedSaturation = 68;
        }
      ...
      renderHueSlider() {
        ...
        if (!el) return;
        const disp = {
          s: Math.round(Number(this.selectedSaturation) || 0),
          v: Math.round(Number(this.selectedLightness) || 90)
        };
