...
(function (root) {
  ...
  class SimplifiedQuiltAppV2QuoteUi {
      ...
      /** Neutral startup + daily reset: hue/value max, saturation min. */
      _pickerStartupHSV() {
        ...
        return {
          ...
          s: Number.isFinite(s) ? Math.max(0, Math.min(100, Math.round(s))) : 0,
      ...
      renderValueSlider() {
        ...
        this._applyPickerTrackGradient(
          el,
          `linear-gradient(to right, ${Utils.hsvToHex(this.selectedHue, this.selectedSaturation, vMin)}, ${Utils.hsvToHex(this.selectedHue, this.selectedSaturation, vMax)})`
        );
      }
