...
function (global) {
  ...
  const TAPE_MARK_TINT = 'rgba(38, 28, 20, 0.42)';
  ...
  function injectStyles() {
    ...
    const css = `
      #screen-quilt .quilt-mood-collage {
        ...
        --collage-tape-mark-opacity: 0.72;
        --collage-tape-mark-filter: brightness(0.78) contrast(1.06) saturate(0.74);
        position: relative;
        display: block;
        width: 100%;
      ...
      #screen-quilt .quilt-mood-collage__tape.is-scratch-ready .quilt-mood-collage__tape-marks {
        opacity: var(--collage-tape-mark-opacity, 0.72);
