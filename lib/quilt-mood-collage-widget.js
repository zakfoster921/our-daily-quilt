...
function (global) {
  ...
  const STYLE_ID = 'quilt-mood-collage-widget-styles-v42';
  const COLLAGE_BUILD = 'v150';
  ...
  function mount(host, opts = {}) {
    ...
    // Tint after the img exists — earlier call raced and could skip applying the card art.
