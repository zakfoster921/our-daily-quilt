  ...
  class SimplifiedQuiltAppV2Share {
      ...
      async handleAdminTuneSpeakerCutout() {
        ...
        try {
          ...
          let postQuiltAssetsReady = false;
          ...
          const loadTuneAssets = async () => {
            try {
              ...
              const loadPostQuiltForTune = async () => {
                try {
                  const postPack = await odqPromiseWithTimeout(
                  ...
                  if (!postPack?.blob) return false;
                  postHighResBlob = postPack.blob;
                  postTuneQuiltSource = postPack.quiltSource || 'carousel-quilt-screen';
                  postQuiltAssetsReady = true;
                  ...
                  this.logger.warn('Tune modal: post quilt source skipped', postErr);
                  return false;
                }
              };
              const [
              ...
              postTuneQuiltSource = `${tuneQuiltSource}-post-pending`;
