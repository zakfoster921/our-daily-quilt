      ...
      async handleAdminTuneQuiltMirror() {
        ...
        const readSavedTune = () =>
          typeof globalThis.odqReadMirrorTuneFromLocal === 'function'
            ...
            : { flipX: true, flipY: true, updatedAt: '' };
        ...
        let draftTune = {
          ...
          nudgeSeamX: Number(savedTune.nudgeSeamX) || 0,
        ...
        modal.innerHTML = `
          <div class="odq-mirror-tune-panel" role="dialog" aria-modal="true" aria-label="Tune quilt mirror">
            ...
            <details class="odq-mirror-tune-details" open style="margin-top:8px;">
              ...
              <div class="odq-mirror-tune-nudge" aria-label="Nudge seam position">
                <div class="odq-mirror-tune-nudge-row" style="display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin:6px 0;">
                  ...
                  <button type="button" data-seam-nudge="left" aria-label="Nudge seam left">←</button>
                  ...
                  <button type="button" data-seam-nudge="right" aria-label="Nudge seam right">→</button>
                </div>
                <div class="odq-mirror-tune-nudge-row" style="display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin:6px 0;">
                  <span style="font-size:12px;min-width:52px;">Big nudge</span>
                  <button type="button" data-seam-big-nudge="left" aria-label="Big nudge seam left">⇐</button>
                  ...
                  <button type="button" data-seam-big-nudge="right" aria-label="Big nudge seam right">⇒</button>
        ...
        const applyDraftToUi = () => {
          ...
          if (seamNudgeStatusEl) {
            seamNudgeStatusEl.textContent = `Horizontal ${formatNudge(draftTune.nudgeSeamX)} · Vertical ${formatNudge(draftTune.nudgeSeamY)}`;
          }
        };
        ...
        const writeDraftTuneLocal = () => {
          if (typeof globalThis.odqWriteMirrorTuneLocal === 'function') {
            globalThis.odqWriteMirrorTuneLocal(todayKey, {
              ...
              nudgeSeamX: draftTune.nudgeSeamX,
        ...
        const applySeamNudge = (direction, big) => {
          ...
          if (direction === 'left') draftTune.nudgeSeamX = clampNudge(draftTune.nudgeSeamX + step);
          else if (direction === 'right') draftTune.nudgeSeamX = clampNudge(draftTune.nudgeSeamX - step);
          else if (direction === 'up') draftTune.nudgeSeamY = clampNudge(draftTune.nudgeSeamY - step);
        ...
        modal.querySelector('[data-action="reset"]')?.addEventListener('click', () => {
          draftTune = { flipX: true, flipY: true, nudgeSeamX: 0, nudgeSeamY: 0 };
          dirty = true;
          applyDraftToUi();
          applyDraftPreview();
        ...
        modal.querySelector('[data-action="save"]')?.addEventListener('click', async () => {
          ...
          try {
            if (typeof globalThis.odqWriteMirrorTuneViaServer === 'function') {
              await globalThis.odqWriteMirrorTuneViaServer(todayKey, {
                flipX: draftTune.flipX,
                flipY: draftTune.flipY,
                nudgeSeamX: draftTune.nudgeSeamX,
                nudgeSeamY: draftTune.nudgeSeamY,
            ...
            savedTune.flipX = draftTune.flipX;
            savedTune.flipY = draftTune.flipY;
            savedTune.nudgeSeamX = draftTune.nudgeSeamX;
            savedTune.nudgeSeamY = draftTune.nudgeSeamY;
            savedTune.updatedAt = updatedAt;
            dirty = false;
