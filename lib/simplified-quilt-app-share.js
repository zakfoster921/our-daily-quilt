  ...
  class SimplifiedQuiltAppV2Share {
      ...
      async handleAdminTuneSpeakerCutout() {
        ...
        try {
          ...
          try {
            await Promise.all([
              odqReadLayoutBQuoteStripOffset?.(todayKey, 'story'),
              odqReadLayoutBQuoteStripOffset?.(todayKey, 'post')
            ]);
          } catch (_) {
          ...
          const copyStoryQuoteStyleToPost = () => {
            ...
            tuneDraftByAspect.post.quoteStripOffset =
              odqNormalizeQuoteStripOffset?.(s.quoteStripOffset) || { x: 0, y: 0 };
          };
          ...
          const applyDraftToUi = (aspect) => {
            ...
            quoteStripOffset = odqNormalizeQuoteStripOffset?.(
              a === 'post' && !postQuoteStyleIndependent
          ...
          const aspectPreviewCacheKey = (aspect) => {
            ...
            return [
              ...
              odqNormalizeQuoteStripOffset?.(layoutDraft.quoteStripOffset)?.x || 0,
              odqNormalizeQuoteStripOffset?.(layoutDraft.quoteStripOffset)?.y || 0,
