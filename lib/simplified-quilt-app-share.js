                  ...
                  if (serverApiOk) {
                    ...
                    if (verifyResult && !verifyResult.ok) {
                      ...
                      if (
                        ...
                        try {
                          await odqPromiseWithTimeout(
                            globalThis.odqWriteLayoutBPostStripPlan(saveDateKey, postStripPlanForSave, {
                              updatedAt: tuneSavedAt
                            }),
                            12000,
                            'Post strip plan client confirm'
                          );
                        } catch (stripPlanErr) {
                          this.logger.warn('Tune save: strip plan client confirm failed', stripPlanErr);
                        }
                      }
                    }
