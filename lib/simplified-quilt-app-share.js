      ...
      async handleAdminTuneQuiltMirror() {
        ...
        modal.innerHTML = `
          <div class="odq-mirror-tune-panel" role="dialog" aria-modal="true" aria-label="Tune quilt mirror">
            ...
            <p style="margin:0 0 10px;font-size:12px;opacity:.75;">Bottom field for ${todayKey}. Live preview on the quilt behind this panel.</p>
            <div class="odq-mirror-tune-mode" style="margin-bottom:10px;font-size:13px;">Mode: <strong data-mode-label></strong></div>
        ...
        `;
        modal.style.cssText =
          'position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:100060;display:flex;align-items:flex-end;justify-content:center;padding:16px;';
        const panel = modal.querySelector('.odq-mirror-tune-panel');
        panel.style.cssText =
          'background:#fff;border-radius:10px;padding:14px 16px;max-width:420px;width:100%;box-shadow:0 8px 32px rgba(0,0,0,.35);';
