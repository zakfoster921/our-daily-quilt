...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Share {
      ...
      _setQuiltHtmlDimActive(active, fadeMs = 500) {
      ...
      _setQuiltSpotlightDimActive(active, fadeMs = 500) {
        ...
        if (!active && !alreadyActive && !dim) {
          this._setQuiltHtmlDimActive(false, fadeMs);
          return;
        }
        ...
        const targetFillOpacity = active ? '0.36' : '0';
        if (dimEl) {
        ...
        this._setQuiltHtmlDimActive(active, fadeMs);
      }
      ...
      _finishMyBlockSpotlight() {
        ...
        if (pending?.group) {
          ...
          if (pending.mode === 'simple') {
            /* class removed above */
          } else if (pending.mode === 'clone') {
        ...
        svg?.classList.remove('quilt-spotlight-active', 'quilt-spotlight-dim-instant');
      }
      ...
      async handleShowMyBlock() {
        ...
        if (this._prefersSimpleQuiltSpotlight()) {
          sourceGroup.classList.add('quilt-my-block-spotlight-in-place');
          this._myBlockSpotlightRestore = { mode: 'simple', group: sourceGroup, synthetic };
