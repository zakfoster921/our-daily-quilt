...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Share {
      ...
      async handleShowMyBlock() {
        ...
        const nextSibling = synthetic ? null : g.nextSibling;
        const restoreOrder = () => {
          g.style.transform = '';
          ...
          try {
            if (nextSibling && nextSibling.parentNode === layer) {
              layer.insertBefore(g, nextSibling);
            }
          } catch (e) {
            /* ignore */
          }
        ...
        // Bring forward within the same layer so split-band / parallax transforms stay intact.
        layer.appendChild(g);
