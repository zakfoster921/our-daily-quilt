  ...
  class SimplifiedQuiltAppV2Share {
      ...
      async handleAdminTuneQuiltMirror() {
        ...
        modal.querySelector('[data-action="reset"]')?.addEventListener('click', () => {
          draftTune = { flipX: true, flipY: true, nudgeSeamY: 0, nudgeMirrorY: 0 };
          dirty = true;
          applyDraftToUi();
          applyDraftPreview();
        ...
        modal.querySelector('[data-action="save"]')?.addEventListener('click', async () => {
          ...
          const previousTune = {
            flipX: savedTune.flipX,
            flipY: savedTune.flipY,
            nudgeSeamY: savedTune.nudgeSeamY,
            nudgeMirrorY: savedTune.nudgeMirrorY
          };
          ...
          try {
            ...
            savedTune.nudgeMirrorY = draftTune.nudgeMirrorY;
