...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    formatReflectionCarouselStripHtml(strip, dateKey, stripIndex = 0, slideIndex = 0, options = {}) {
      ...
      const tapeMarkup = options.includeTape
    ...
    syncReflectionCarouselSplitTape(slides) {
      ...
      list.forEach((slide) => {
        ...
        const seamY = (topRect.bottom + bottomRect.top) / 2 - topRect.top;
