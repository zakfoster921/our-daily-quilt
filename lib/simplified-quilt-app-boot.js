...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    _refreshQuoteSpeakerWidgetNowInner(quote = null) {
      ...
      const attributionEl = document.getElementById('quoteSpeakerAttribution');
      const stage = document.getElementById('quoteSpeakerStage');
      const heartEl = document.getElementById('quoteSpeakerBirthdayHeart');
      ...
      if (!profile) {
        ...
        if (heartEl) heartEl.hidden = true;
      ...
      if (heartEl || glitterEl || birthdayCaptionEl) {
        ...
        if (heartEl) heartEl.hidden = !isBirthday;
        if (glitterEl) {
