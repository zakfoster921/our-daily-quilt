  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    _maybeSnapPickerToDailyFirstPalette(opts = {}) {
      ...
      try {
        ...
        const moodHex =
          typeof this._getTodayQuoteMoodHex === 'function' ? this._getTodayQuoteMoodHex() : null;
        if (moodHex && typeof this._applyPickerHexColor === 'function' && this._applyPickerHexColor(moodHex)) {
        ...
        const quoteReady = !!this.quoteService?.getTodayQuote?.();
        if (!quoteReady && !forceDaily) return;
    ...
    _ensureIgReflectionExportStyles() {
      ...
      style.textContent = `
        ...
        #screen-quilt.is-ig-export .quilt-reflection-carousel-slide--clipping:not(.quilt-reflection-carousel-slide--ig-export-response):not(.quilt-reflection-carousel-slide--ig-prompt) {
          width: ${patchW}px !important;
          max-width: ${patchW}px !important;
          flex: 0 0 auto !important;
        }
    ...
    _ensureIgReflectionCaptureStyles() {
      ...
      css += `
        ...
        ${ROOT} .quilt-reflection-carousel-slide--clipping:not(.quilt-reflection-carousel-slide--ig-export-response):not(.quilt-reflection-carousel-slide--ig-prompt) {
