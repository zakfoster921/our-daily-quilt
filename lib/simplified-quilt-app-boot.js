...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    /**
     * Top-of-head point in natural image pixels — center-band scan so side hair/ears don't
     * pull the crown up, and white paper mat is ignored (same subject test as crop bounds).
     */
