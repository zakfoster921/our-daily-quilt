...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    _refreshQuoteSpeakerWidgetNowInner(quote = null) {
      ...
      const attributionEl = document.getElementById('quoteSpeakerAttribution');
      const stage = document.getElementById('quoteSpeakerStage');
      const buntingEl = document.getElementById('quoteSpeakerBunting');
      ...
      if (!profile) {
        ...
        if (buntingEl) buntingEl.hidden = true;
      ...
      if (buntingEl || glitterEl || birthdayCaptionEl) {
        ...
        if (buntingEl) buntingEl.hidden = !isBirthday;
        if (glitterEl) {
