...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    /** Dev/preview: ?screen=zak|mission|welcome|bridge|first-name|portal|quote|color|leaderboard|qnlb=submissions|birthdayPreview=tomorrow|firstTime=1 */
    ...
    _quoteSpeakerStoryCutoutBakeOptions(bakeLayout = {}) {
      ...
      return {
        bakeKey: `${nameStripPaper}|quilt-name-strip-v2`,
        options: {
          isCutoutPng: true,
          skipScannerBed: true,
    ...
    _applyQuoteSpeakerPlainCutoutBacking(cutout, img, sourceUrl = '') {
      ...
      const paperSig = `${layoutSig}|${bakeKey}|story-over-quilt-v16`;
      const compositeReady =
