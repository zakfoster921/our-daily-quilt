...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    _quoteSpeakerStoryCutoutBakeOptions(bakeLayout = {}) {
      ...
      return {
        bakeKey: `${nameStripPaper}|quilt-name-strip-v1`,
        options: {
          isCutoutPng: true,
          skipScannerBed: true,
          ...
          seed: paperSeed,
          paperTooth: true,
          paperToothSeed: `${paperSeed}:quilt-speaker`,
    ...
    _applyQuoteSpeakerPlainCutoutBacking(cutout, img, sourceUrl = '') {
      ...
      const paperSig = `${layoutSig}|${bakeKey}|story-over-quilt-v11`;
      const compositeReady =
      ...
      const applySlide1CutoutDisplay = async (sourceImg) => {
        ...
        const layoutAfterComposite = () => {
          ...
          this._syncQuoteSpeakerNameTuck(cutout, srcImg);
          finishPlainCutoutBacking();
        };
