...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    /** Speaker card: portrait column fits inside 90% of the identity name strip after tilt bleed. */
    ...
    _refineQuoteSpeakerPortraitWidthAfterLayout(widget, cutout, img) {
      ...
      if (frameH < 48) return;
      const boxW = this._quoteSpeakerLayoutBoxW(cutout);
      if (!this._syncQuoteSpeakerPortraitWidthFromNameStrip(widget, frameH)) return;
