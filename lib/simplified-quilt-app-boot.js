    ...
    _ensureIgReflectionExportStyles() {
      ...
      style.textContent = `
        ...
        #screen-quilt.is-ig-export {
          ...
          background: transparent;
          overflow: visible;
          --quilt-quote-copy-size: 32px;
          --quilt-reflection-theme-size: 31px;
          --quilt-reflection-prompt-question-size-scale: 1.04;
          --reflection-clipping-card-max: ${patchW}px;
          --reflection-patch-w: ${patchW}px;
          --reflection-clipping-pad-y: calc(14px + var(--reflection-clipping-edge-y));
          --reflection-clipping-pad-x-outer: 36px;
          --reflection-clipping-edge-y: 14px;
          --reflection-question-card-width: min(100%, 480px);
