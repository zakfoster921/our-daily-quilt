  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    _applyQuoteSpeakerWashColors(widget) {
      ...
      const haloColor =
        ...
        '#d6977e';
      const SCR = globalThis.SpeakerCutoutRender;
      const safeHaloColor = SCR?.washOutSpeakerQuiltColor
    ...
    _applyQuoteSpeakerCutoutRenderPlan(cutout) {
      ...
      const plan = SCR.buildSpeakerCutoutPlan({
        ...
        palette: cardColors.palette || []
      });
      const isSpeakerCutout = cutout.classList.contains('quote-speaker-cutout--single-layer');
