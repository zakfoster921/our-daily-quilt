...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    /** Horizontal tape vertical center — lower-z card bottom meets upper-z card top. */
    _reflectionJoinTapeSeamYForPair(patchA, patchB) {
      ...
      const lowerPaperBottom = lowerR.bottom + this._readReflectionPatchPaperEdgeY(lowerPatch);
      const upperPaperTop = upperR.top - this._readReflectionPatchPaperEdgeY(upperPatch);
      return (lowerPaperBottom + upperPaperTop) / 2;
    }
