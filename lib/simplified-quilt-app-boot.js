  ...
  class SimplifiedQuiltAppV2Boot {
    ...
    _ensureIgReflectionExportStyles() {
      ...
      style.textContent = `
        ...
        #screen-quilt.is-ig-export {
          ...
          --reflection-question-card-width: min(100%, 440px);
        ...
        #screen-quilt.is-ig-export .quilt-reflection-prompt-question {
          font-size: ${promptPx}px !important;
          line-height: 1.18 !important;
        }
        #screen-quilt.is-ig-export .quilt-reflection-question-paper-body.is-long-prompt .quilt-reflection-scrap-text {
          font-size: ${Math.max(52, promptPx - 8)}px !important;
        }
    ...
    _ensureIgReflectionCaptureStyles() {
      ...
      css += `
        ...
        ${ROOT} .quilt-reflection-question-paper-body.is-long-prompt .quilt-reflection-scrap-text {
          font-size: ${Math.max(52, promptPx - 8)}px !important;
        }
    ...
    async _captureIgReflectionExportElement(sourceEl, dateKey) {
      ...
      if (root.classList.contains('quilt-reflection-carousel-slide--clipping')) {
        ...
        const promptPx = this._igReflectionExportPromptQuestionPx();
        root.querySelectorAll('.quilt-reflection-scrap-text, .quilt-reflection-prompt-question').forEach((el) => {
          el.style.fontSize = `${promptPx}px`;
