...
const PREFILL_CREATIVE_PROMPT_VERSION = '2026-07-07-art-recs-colon-v1';
 ...
 * @param {{ quoteText: string, authorName: string, promptThemeOptions?: string[], isSeamside?: boolean }} params
 */
function buildSubmittedQuotePrefillPrompt({ quoteText, authorName, promptThemeOptions, isSeamside = false }) {
