...
const PREFILL_CREATIVE_PROMPT_VERSION = '2026-07-28-mood-select-v1';
...
const QUOTE_MOOD_OPTIONS = [
  ...
  'Bittersweet — beauty and pain held together'
];
...
function resolveMoodOption(moodOptions, value) {
  ...
  const shortKey = text.split('—')[0].split(' - ')[0].trim().toLowerCase();
  if (shortKey) {
