 ...
 *   what_if, speaker_guide_line, art_recs, good_day, rough_day
 *
...
const SYSTEM_PROMPT = [
  ...
  'Always include small_act as a non-empty string. If the quote is abstract, translate its theme into one concrete interpersonal gesture the reader can complete before day end.'
].join(' ');
