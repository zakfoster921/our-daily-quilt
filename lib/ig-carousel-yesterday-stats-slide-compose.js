...
(function (root, factory) {
  ...
  function (global) {
    ...
    function drawQuiltScrap(ctx, quiltImg, quiltRect, points, panelW, panelH) {
      ...
      return [
        {
          name: 'top-left-strip',
          points: [
            { x: jitter(52, 24), y: jitter(118, 30) },
            { x: jitter(118, 20), y: jitter(92, 24) },
            { x: jitter(132, 18), y: jitter(286, 36) },
            { x: jitter(64, 22), y: jitter(312, 32) }
          ]
        },
        {
          name: 'top-right-sliver',
          points: [
            { x: jitter(panelW * 0.72, 40), y: jitter(96, 28) },
            { x: jitter(panelW * 0.96, 20), y: jitter(72, 22) },
            { x: jitter(panelW * 0.93, 18), y: jitter(148, 26) },
            { x: jitter(panelW * 0.68, 36), y: jitter(176, 30) }
          ]
        },
        {
          name: 'bottom-right-chunk',
          points: [
            { x: jitter(panelW * 0.74, 34), y: jitter(panelH * 0.78, 40) },
            { x: jitter(panelW * 0.98, 16), y: jitter(panelH * 0.74, 34) },
            { x: jitter(panelW * 0.94, 18), y: jitter(panelH * 0.94, 24) },
            { x: jitter(panelW * 0.7, 38), y: jitter(panelH * 0.98, 20) }
          ]
        }
      ];
    }
    ...
    function drawCollageScraps(ctx, quiltImg, quiltRect, panelW, panelH, dateKey) {
      ...
      for (const scrap of scraps) {
        drawQuiltScrap(ctx, quiltImg, quiltRect, scrap.points, panelW, panelH);
      }
      ctx.restore();
