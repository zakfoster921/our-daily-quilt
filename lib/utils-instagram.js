...
(function (root) {
  ...
  Object.assign(UtilsCore, {
     ...
     * `carousel-slide-1.png` = layout B (quote 4:5). `carousel-slide-2.png` + `carousel-slide-3.png` = seamless quilt contributor pair.
     * `layout-b.png` = optional legacy upload when layout B is passed only via postLayoutBImageData; nightly sets layoutBUrl = carouselSlide1Url.
    ...
    async writeInstagramImagesDocForZapier({
      ...
      if (carouselSlide1ImageStorageUrl) {
        ...
        // Slide 1 is layout B in the integrated 3-slide carousel.
