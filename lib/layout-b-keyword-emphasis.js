...
if (typeof fetch === 'function') {
  fetch('http://127.0.0.1:7433/ingest/0ed8adaa-5aed-4571-811f-aadcc7a8fddc', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', 'X-Debug-Session-Id': 'ac71a1' },
    body: JSON.stringify({
      sessionId: 'ac71a1',
      location: 'layout-b-keyword-emphasis.js:boot',
      message: 'library executed',
      data: { hasLBKE: !!(global && global.LayoutBKeywordEmphasis) },
      timestamp: Date.now(),
      hypothesisId: 'H2'
    })
  }).catch(function () {});
