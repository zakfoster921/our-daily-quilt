...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Social {
    ...
    drawSocialPostStoryHeaderPaper(ctx, layout, fillColor) {
    ...
    drawSocialPostStoryHeader(ctx, { padX, textMaxW, padTop = 192, storyW = 1080, paperFill } = {}) {
      const layout = this.measureSocialPostStoryHeader(ctx, { padX, textMaxW, padTop, storyW });
      this.drawSocialPostStoryHeaderPaper(ctx, layout, paperFill);
