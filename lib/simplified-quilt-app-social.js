...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Social {
    ...
    buildSocialPostCarouselHtml(items, { classPrefix = 'social-post', imagePriority = 'auto' } = {}) {
      ...
      return `<div class="${classPrefix}-carousel" data-slide-count="${media.length}"${carouselStyle}><div class="${classPrefix}-carousel-track">${slides}</div><div class="${classPrefix}-carousel-dots">${dots}</div></div>`;
    }
