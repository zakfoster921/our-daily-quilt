...
function (global) {
  ...
  /** System serif stack for in-browser export (avoids cross-origin webfont canvas taint). */
  const MOOD_BROWSER_EXPORT_FONT = 'Georgia, "Times New Roman", Times, serif';
