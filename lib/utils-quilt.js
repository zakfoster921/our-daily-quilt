...
(function (root) {
  ...
  Object.assign(UtilsCore, {
    getQuiltDimensions() {
      const hasVisualViewport = root.visualViewport && root.visualViewport.width > 0;
      
      let screenWidth, screenHeight;
      
      if (hasVisualViewport) {
        screenWidth = root.visualViewport.width;
        screenHeight = root.visualViewport.height;
      } else {
        const body = root.root.document.body;
        const html = root.root.document.documentElement;
