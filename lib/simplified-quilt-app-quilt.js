  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    showColorSubmitTransition(color, message = this.getColorSubmitPlacementMessage()) {
      ...
      overlay.classList.remove(
        'color-submit-transition--piece',
        'color-submit-transition--piece-visible',
      ...
      const spinner = overlay.querySelector('.color-submit-transition__spinner');
    ...
    async playColorSubmitPieceReveal(block) {
      ...
      overlay.classList.remove('color-submit-transition--piece-visible', 'color-submit-transition--piece-exit');
      overlay.classList.add('color-submit-transition--piece');
      ...
      this.updateColorSubmitTransition("Here's your piece");
      await this.waitForNextPaint();
      overlay.classList.add('color-submit-transition--piece-visible');

      await this.wait(reduceMotion ? 900 : 1200);
      this.updateColorSubmitTransition('Finding its place…');
      await this.wait(reduceMotion ? 450 : 700);

      overlay.classList.add('color-submit-transition--piece-exit');
      await this.wait(reduceMotion ? 220 : 520);
    }
