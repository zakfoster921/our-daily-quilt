  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    syncContributorCloudDebug(panelBody, listEl, metrics = {}) {
      ...
      if (!layer) {
        ...
        layer.innerHTML = [
          '<div class="quilt-contributor-debug-line quilt-contributor-debug-line--bottom-limit" data-debug-label="bottom guard (-3px)"></div>',
      ...
      const bottomLimit = Number(metrics.bottomLimit) || (listRect.bottom - 3);
    ...
    fitContributorCloudToViewport(listEl) {
      ...
      let guard = 0;
      let bottomLimit = listEl.getBoundingClientRect().bottom - 3;
      while (guard < 16) {
        bottomLimit = listEl.getBoundingClientRect().bottom - 3;
