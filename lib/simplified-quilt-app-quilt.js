...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    async _tryStoredLayoutBStoryPreview(dateKey, previewContentKey = '', options = {}) {
      ...
      /** Prefer one baked story PNG (quilt + strips + speaker aligned). Layered quilt-screen +
       *  overlay is fallback only — quilt-screen uses live phone aspect, not story 1080×1920 frame. */
