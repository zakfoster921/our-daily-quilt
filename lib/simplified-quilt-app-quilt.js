  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    async runPostColorCutRevealSubmit(selectedColor) {
      ...
      try {
        ...
        /**
         * Hard rule: zero quilt work during the cut animation.
         * After the last scrap, keep the mat up → paint quilt under it → fast fade.
         */
        const fireQuiltHandoff = () => {
          ...
          quiltHandoffPromise = (async () => {
            ...
            try {
              ...
              // Final mat pose stays on screen while we build the quilt underneath.
              ...
              if (!applyPromise) {
                applyPromise = this.applyServerColorSubmissionResult(serverResult, selectedColor)
                  ...
                  .catch((applyErr) => {
                    this.logger.warn('Apply during cut reveal handoff failed:', applyErr);
                    return null;
                  });
              }
