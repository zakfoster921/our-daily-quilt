  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    async runPostColorCutRevealSubmit(selectedColor) {
      ...
      try {
        ...
        const dismissCutRevealMat = async () => {
        ...
        const fireQuiltHandoff = () => {
          ...
          quiltHandoffPromise = (async () => {
            try {
              // Let the completed cut frame paint and fade away before any quilt
              // hydration or rendering can occupy the main thread.
              await this.waitForNextPaint();
              await dismissCutRevealMat();
              ...
              // Blocks only — full renderQuilt (mood collage, Layout B, etc.) can take 10s+.
