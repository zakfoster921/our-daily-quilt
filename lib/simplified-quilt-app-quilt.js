      ...
      try {
        ...
        playResult = await controller.playWithSubmission(submitPromise, {
          ...
          onCutsComplete: (livePreview) => {
            ...
            applyPromise = this.applyServerColorSubmissionResult(resolved, selectedColor)
              .then((result) => {
                applyResult = result;
                return result;
              })
      ...
      try {
        ...
        if (useCutReveal) {
          try {
            ...
            if (revealOutcome.applyPromise) {
              try {
                result = (await revealOutcome.applyPromise) || result;
              } catch (applyErr) {
                this.logger.warn('Apply after cut reveal failed:', applyErr);
              }
            }
