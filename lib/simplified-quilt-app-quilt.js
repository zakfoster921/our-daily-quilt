...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    async _refreshLayoutBStoryPreviewCore() {
      ...
      const contentKey = `live:${dk}:${currentFp}:${mirrorSig || 'tune0'}:${speakerTuneSig || 'spk0'}`;
