  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    async runPostColorCutRevealSubmit(selectedColor) {
      ...
      try {
        ...
        const paintQuiltUnderMat = async () => {
          ...
          // Two frames so the quilt actually composites before opacity drops.
          await new Promise((resolve) => {
            requestAnimationFrame(() => requestAnimationFrame(resolve));
          });
        ...
        const fireQuiltHandoff = () => {
          ...
          quiltHandoffPromise = (async () => {
            ...
            try {
              // Keep mat opaque until the quilt is painted underneath — otherwise white flash.
        ...
        try {
          playResult = await controller.playWithSubmission(submitPromise, {
            ...
            onBeforeCuts: () => {
              activateQuiltUnderMat();
              // One paint after showScreen before the first cut pose.
              return new Promise((resolve) => {
                requestAnimationFrame(() => requestAnimationFrame(resolve));
              });
            }
