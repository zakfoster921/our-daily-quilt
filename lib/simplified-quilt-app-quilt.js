...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    resetQuiltParallaxVisualState() {
      ...
      // Keep resting wobble energy so a re-render doesn't kill motion until the next scroll.
      this._wobbleEnergy = this.quiltWobbleEnabled ? 0.45 : 0;
      this._wobbleEnergyTarget = this.quiltWobbleEnabled ? 0.45 : 0;
      ...
      // Re-renders clear transforms and can stall the RAF loop — kick wobble again.
