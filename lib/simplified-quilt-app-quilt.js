  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    async runPostColorCutRevealSubmit(selectedColor) {
      ...
      try {
        ...
        /**
         * Animation stays quilt-free. Data apply may start between cut poses.
         * Handoff: showScreen + paint under opaque mat → fast fade.
         */
        const fireQuiltHandoff = () => {
          ...
          quiltHandoffPromise = (async () => {
            ...
            try {
              ...
              // Let the last scrap pose paint once before we take the main thread.
        ...
        // When the server answers, schedule apply for the next between-cut gap.
