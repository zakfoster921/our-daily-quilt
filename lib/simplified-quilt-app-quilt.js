...
(function (root) {
  ...
  class SimplifiedQuiltAppV2Quilt {
    ...
    async handleAddColor() {
      ...
      let cutRevealApplyPromise = null;
      ...
      try {
        ...
        if (useCutReveal) {
          try {
            ...
            cutRevealApplyPromise = revealOutcome.applyPromise || null;
        ...
        if (result) {
          ...
          this.hideColorSubmitTransition();
          if (cutRevealFinished && cutRevealApplyPromise) {
            try {
              result = (await cutRevealApplyPromise) || result;
            } catch (applyErr) {
