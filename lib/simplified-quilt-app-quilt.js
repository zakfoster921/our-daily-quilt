          ...
          if (ok) {
            ...
            if (satisfiesPreview) {
              ...
              if (useLayeredPreview) {
                void this._prepareStoredLayoutBStoryPreviewLayeredShareBlob(
                  quiltScreenUrl,
                  overlayUrl,
                  this._layoutBStoryPreviewContentKey
                );
              } else {
                void this._prepareStoredLayoutBStoryPreviewShareBlob(url, this._layoutBStoryPreviewContentKey);
              }
              if (hint) {
                hint.textContent = '';
                hint.hidden = true;
