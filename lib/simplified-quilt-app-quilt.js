      ...
      try {
        ...
        if (result || cutRevealFinished) {
          ...
          if (!cutRevealFinished) {
            this.markDailyColorCompleted();
            // Light handoff while spinner is up — full quilt chrome was making
            // "Adding your color" sit for several seconds.
            this.uiService.showScreen('screen-quilt', { fastQuiltHandoff: true });
            await this.waitForNextPaint();
          }
          this.hideColorSubmitTransition();
          if (cutRevealQuiltHandoffPromise) {
            ...
            try {
              ...
              this.ensureQuiltScreenInteractive?.();
              // Heavier chrome after the spinner is gone.
              void (async () => {
                try {
                  void this.refreshAdminDailyTaskBanner?.();
                  this._scheduleAdminDailyTaskBannerPolling?.();
                  ...
                  this.logger.warn('Post color-submit quilt chrome failed:', chromeErr);
                }
              })();
            } catch (renderError) {
