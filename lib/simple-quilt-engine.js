...
class SimpleQuiltEngine {
  ...
  _tryMacroFlattenedAngledSplit(block, newColor, ctx) {
    ...
    let worldA = this._finalizeMacroPolygonWorldPieces(
      this._clipPolygonPiecesByProjection(world, nx, ny, cut, keepLessForA)
    );
    let worldB = this._finalizeMacroPolygonWorldPieces(
      this._clipPolygonPiecesByProjection(world, nx, ny, cut, !keepLessForA)
    );
  ...
  splitVisibleFlattenedMacroBlock(block, newColor) {
    ...
    const splitBy = (direction) => {
      ...
      const weldedA = this._finalizeMacroPolygonWorldPieces(
        this._snapPolygonWorldPiecesToSharedEdges(aPieces, block)
      );
      const weldedB = this._finalizeMacroPolygonWorldPieces(
  ...
  splitDiagonalAxisPattern(block, newColor) {
    ...
    const worldA = this._finalizeMacroPolygonWorldPieces(
      this._snapPolygonWorldPiecesToSharedEdges(
        this._clipPolygonPiecesByProjection(world, nx, ny, adjustedCut, true),
        block
      )
    );
    const worldB = this._finalizeMacroPolygonWorldPieces(
      this._snapPolygonWorldPiecesToSharedEdges(
