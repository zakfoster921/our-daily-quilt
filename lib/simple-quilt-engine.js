...
class SimpleQuiltEngine {
  ...
  _tryMacroFlattenedAngledSplit(block, newColor, ctx) {
    ...
    let worldA = this._snapPolygonWorldPiecesToSharedEdges(
      this._clipPolygonPiecesByProjection(world, nx, ny, cut, keepLessForA),
      block
    );
    let worldB = this._snapPolygonWorldPiecesToSharedEdges(
      this._clipPolygonPiecesByProjection(world, nx, ny, cut, !keepLessForA),
      block
    );
  ...
  splitVisibleFlattenedMacroBlock(block, newColor) {
    ...
    const splitBy = (direction) => {
      ...
      const weldedA = this._snapPolygonWorldPiecesToSharedEdges(aPieces, block);
      const weldedB = this._snapPolygonWorldPiecesToSharedEdges(bPieces, block);
