...
class SimpleQuiltEngine {
  ...
  /** Light blocks beside/on darker neighbors (hand-cut bleed overlaps) use reduced opacity. */
  static LIGHT_OVER_DARK_MIN_TOP_LUMINANCE = 110;
  static LIGHT_OVER_DARK_MIN_LUMINANCE_DELTA = 20;
  static LIGHT_OVER_DARK_FILL_OPACITY = 0.82;
  /** Logical quilt cells only touch at edges; hand-cut jitter bleeds a few px into neighbors. */
  static LIGHT_OVER_DARK_ADJACENCY_PADDING = 6;
