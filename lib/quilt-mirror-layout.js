...
(function (root) {
  ...
  function computeFromBounds(bounds, options = {}) {
    ...
    const nudgeSeamX = odqNormalizeMirrorSeamNudge(mirrorTune?.nudgeSeamX);
    const nudgeSeamY = odqNormalizeMirrorSeamNudge(mirrorTune?.nudgeSeamY);
    const targetSeamFraction = clampSeamTarget(layout.targetSeamFraction + nudgeSeamY);
    ...
    const viewBox = options.quadrantFourUp
      ...
      : (() => {
          ...
          if (nudgeSeamX !== 0) {
            return { ...solved, x: solved.x + nudgeSeamX * solved.width };
          }
          return solved;
        })();
    return {
  ...
  function odqParseMirrorTuneRaw(raw) {
    ...
    return {
      ...
      nudgeSeamX: odqNormalizeMirrorSeamNudge(raw.nudgeSeamX),
  ...
  function odqMirrorTuneFromQuiltData(data) {
    ...
    const hasFields =
      ...
      Object.prototype.hasOwnProperty.call(d, 'mirrorSeamNudgeX') ||
    ...
    return {
      ...
      nudgeSeamX: odqNormalizeMirrorSeamNudge(d.mirrorSeamNudgeX),
  ...
  function odqMirrorTuneIsCustomized(tune) {
    ...
    return (
      ...
      odqNormalizeMirrorSeamNudge(t.nudgeSeamX) !== 0 ||
  ...
  function odqWriteMirrorTuneLocal(dateKey, tune) {
    ...
    const nudgeSeamX = odqNormalizeMirrorSeamNudge(tune?.nudgeSeamX);
    const nudgeSeamY = odqNormalizeMirrorSeamNudge(tune?.nudgeSeamY);
    const payload = { flipX, flipY, nudgeSeamX, nudgeSeamY };
