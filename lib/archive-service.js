...
class ArchiveService {
  ...
  async getInstagramQuiltSourceBlob(blocks, options = {}) {
    ...
    const cacheKey = `${String(options.dateKey || '').trim()}:${fingerprint}:${cacheVariant}:${grainVariant}${maxEdgePart}${mirrorPart}`;
    if (
    ...
    const igAspect =
      typeof globalThis.IG_QUILT_SCREEN_ASPECT === 'number'
        ...
        : 9 / 16;
    const rasterOpts = {
      targetAspect: exportMatchQuiltScreen ? igAspect : null,
