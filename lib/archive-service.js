    ...
    try {
      ...
      if (
        ...
        if (useQuad) {
          ...
          const cellH = outH / 2;
          const left = {
            flipX: tune?.leftFlipX === true,
            flipY: tune?.leftFlipY === true
          };
          const right = {
            flipX: tune?.rightFlipX === true,
            flipY: tune?.rightFlipY === true
          };
          [
            { x: 0, y: 0, flipX: left.flipX, flipY: left.flipY },
            { x: cellW, y: 0, flipX: right.flipX, flipY: right.flipY },
            { x: 0, y: cellH, flipX: left.flipX, flipY: !left.flipY },
            { x: cellW, y: cellH, flipX: right.flipX, flipY: !right.flipY }
          ].forEach((tile) => {
