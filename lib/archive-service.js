...
class ArchiveService {
  ...
  async _captureLayoutBStoryRefStripPlanForPost(highResBlob, quoteText, quoteAuthor, dateKey, seedOpts) {
    ...
    const storyOpts = {
      tuneAspect: 'story',
      keywordEmphasis: seedOpts.keywordEmphasis,
      keywordEmphasisExplicit: seedOpts.keywordEmphasisExplicit,
  ...
  async _buildLayoutBPostComposeOptions(blocks, quoteObj, dateKey) {
    ...
    try {
      keywordEmphasis =
        (await odqReadLayoutBKeywordEmphasis(dk, quoteStyleAspect, q)) || keywordEmphasis;
    } catch (_) {
      /* optional */
    }
