...
class ArchiveService {
  ...
  async _buildLayoutBPostComposeOptions(blocks, quoteObj, dateKey) {
    ...
    if (!postQuoteStyleIndependent && (speakerCutoutUrl || speakerPortraitUrl)) {
  ...
  async generateInstagramPostLayoutBBlob(
    ...
    if (
      ...
      // Carousel slide 1 uses deterministic flow layout; replaying saved x/y scatters short quotes.
    } else if (
      omitQuoteStrips !== true &&
      typeof globalThis.odqReadLayoutBPostStripPlan === 'function'
    ) {
