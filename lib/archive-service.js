...
class ArchiveService {
  ...
  /**
   * Seamless IG carousel (2160×1350 master → two 1080×1350 slides).
   * Slide 1: contributor clipping; slide 2: right-justified classic quilt.
   */
  async generateInstagramCarouselSlideBlobs(blocks, contributors = [], dateKey = null) {
    if (!blocks || blocks.length === 0) return null;
  ...
  async generateInstagramCarouselSlideImageData(blocks, contributors = [], dateKey = null) {
    try {
      const blobs = await this.generateInstagramCarouselSlideBlobs(blocks, contributors, dateKey);
  ...
  /**
   * Integrated 3-slide carousel: slide 1 = layout B (+ speaker seam into slide 2), slides 2–3 = quilt pair.
   */
