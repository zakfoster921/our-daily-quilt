...
class ArchiveService {
   ...
   *   layout B (+ speaker seam baked into yesterday stats) → reflection → contributors
   * Post order (Instagram swipe / carouselSlideNUrl):
   *   1 = layout B, 2 = reflection, 3 = contributors, 4 = yesterday stats (1, 3, 4, 2 content).
   */
  async buildIntegratedInstagramCarouselImageData(
    ...
    let carouselSlide3Reflection = reflectionSlideDataUrl || null;
    const carouselSlideContributors = quiltSlides.slide2;
    const carouselSlideYesterdayStats = carouselSlide2;

    return {
      carouselSlide1,
      carouselSlide2: carouselSlide3Reflection,
      carouselSlide3: carouselSlideContributors,
      carouselSlide4: carouselSlideYesterdayStats,
      /** @deprecated preview alias — reflection is carousel post slide 2 */
      carouselSlide2Reflection: carouselSlide3Reflection,
      meta: {
        ...(quiltSlides.meta || {}),
