...
const CONFIG = {
  APP: {
    ...
    /** Split-band quilt fit: primary width-fit + mirror fills lower band. Enable after QA; ?splitBand=1/0 overrides. ?splitBandSimple=1 forces single mirror for QA (ignores dup×2 tune). */
    quiltSplitBandFit: false,
