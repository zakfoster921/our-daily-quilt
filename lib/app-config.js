...
const CONFIG = {
  APP: {
    ...
    buildId: '20',
    /** Public app URL for native “share with a friend”; leave empty until the listing is live. */
    shareAppUrl: '',
    /** App Store / TestFlight review URL; leave empty until ready. */
    appStoreReviewUrl: '',
    debugMode: false,
    enableAdminTools: typeof odqEnableAdminTools === 'function' ? odqEnableAdminTools() : false,
    /** TEMP: quilt gem that opens exit chamber (#quiltDailyColorsCtaBtn). */
    exitChamberCtaEnabled: false,
    /** TEMP: milestone quilts archive, reveals, and milestone notifications. */
