...
const CONFIG = {
  APP: {
    ...
    /** Feature flag: community posts feed, composer, and comments. Off until ready to ship. */
    ...
    /** One-time per-version announcement for returning users (see maybeShowWhatsNewAnnouncement). */
    whatsNew: {
      version: '2.1',
