...
(function (root) {
  ...
  const ODQ_LAYOUT_B_STORY_RENDER_VERSION = 'story-speaker-25pct-v9';
  ...
  function odqLayoutBIgStripsSkipKeywordEmphasis() {
    ...
    /** Story 9:16 AUTO: cutout area as a fraction of full 1080×1920 canvas (aspect preserved). */
    const ODQ_LAYOUT_B_STORY_SPEAKER_TARGET_AREA_FRAC = 0.20;
    const ODQ_LAYOUT_B_STORY_SPEAKER_MAX_AREA_FRAC = 0.25;
      ...
      return new Promise((resolve, reject) => {
            ...
            const getSpeakerOverlayRect = (img, strips) => {
              ...
              if (isPostLayout) {
                ...
                hardAreaMax = canvasArea * 0.25 * speakerAreaMult;
                targetArea = canvasArea * 0.18 * speakerAreaMult;
                maxW = Math.min(STORY_W - 56, STORY_W * 0.48 * speakerLinearBoost);
                maxH = Math.min(STORY_H - 56, STORY_H * 0.48 * speakerLinearBoost);
              } else {
                hardAreaMax = canvasArea * ODQ_LAYOUT_B_STORY_SPEAKER_MAX_AREA_FRAC;
                targetArea = canvasArea * ODQ_LAYOUT_B_STORY_SPEAKER_TARGET_AREA_FRAC;
                maxW = STORY_W - 56;
                maxH = STORY_H - 56;
              }
