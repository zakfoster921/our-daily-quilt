            ...
            loadQuiltImage()
              .then(async (quiltImg) => {
                ...
                for (const speakerImg of speakerImgs) {
                  ...
                  if (speakerRect && quoteStripPlan?.length) {
                    speakerRect = odqConstrainSpeakerRectToNameStripWidth(speakerRect, quoteStripPlan);
                  }
                ...
                const _useSavedPlan = (() => {
                  ...
                  const matched = odqApplySavedLayoutBStripPlanPositionsByReadingOrder(
                    quoteStripPlan,
                    options.savedPostStripPlan,
                    layoutQuoteText,
                    layoutBPostAuthorName || quoteAuthor,
