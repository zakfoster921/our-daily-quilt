            ...
            loadQuiltImage()
              .then(async (quiltImg) => {
                ...
                const savedPostStripPlan = Array.isArray(options.savedPostStripPlan)
                  ? options.savedPostStripPlan
                  : null;
                const hasSavedCarouselStripPositions =
                  options.replaySavedCarouselStripPlan === true &&
                  carouselStoryStyle &&
                  isPostLayout &&
                  quoteStripPlan.length > 0 &&
                  odqSavedLayoutBPostStripPlanUsable(
                    quoteStripPlan,
                    savedPostStripPlan,
                    layoutQuoteText,
                    layoutBPostAuthorName || quoteAuthor
                ...
                if (
                  ...
                  lastSpeakerRectDrawn &&
                  quoteStripPlan.length &&
                  !hasSavedCarouselStripPositions
                ) {
                ...
                if (!hasSavedCarouselStripPositions && (quoteStripDx || quoteStripDy)) {
                ...
                if (hasSavedCarouselStripPositions) {
                  odqApplySavedLayoutBStripPlanPositionsByReadingOrder(
                    quoteStripPlan,
                    savedPostStripPlan,
                    layoutQuoteText,
