      ...
      return new Promise((resolve, reject) => {
            ...
            loadQuiltImage()
              .then(async (quiltImg) => {
                ...
                /**
                 * layout-b.png never draws the speaker cutout (skipSpeakerDrawOnPost) — maximize type for
                 * all inherited post plans, including speaker days when cutout is story-only.
                 */
